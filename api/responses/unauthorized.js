 ...
 * return res.unauthorized(err, 'some/specific/error/view');
 *
 * NOTE:
...
module.exports = function Unauthorized (data, options) {
      ...
      if (data !== undefined) {
        sails.log.error('Sending 401 ("Unauthorized"") response: \n',data);
      }
      else sails.log.error('Sending empty 401 ("Unauthorized"") response');
      ...
      else return res.view('401', { data: viewData, title: 'Server Error' }, function (err, html) {
